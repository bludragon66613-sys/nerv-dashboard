  ...
  apps: [
    {
      ...
      env: {
        ...
        DASHBOARD_SECRET: process.env.DASHBOARD_SECRET || 'change-me-32-char-secret-xxxxxxxx',
        GITHUB_TOKEN: process.env.GITHUB_TOKEN || '',
        CLAUDE_MEM_URL: 'http://localhost:37777',
        OPENCLAW_PROXY_URL: 'http://localhost:5557',
        OPENCLAW_PROXY_SECRET: process.env.OPENCLAW_PROXY_SECRET || 'change-me-proxy-secret-xxxxxxxxxx',
